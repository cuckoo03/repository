...
public class HttpUploadClient {
	...
	private List<InterfaceHttpData> formpost(ClientBootstrap bootstrap,
		...
		try {
			...
			bodyRequestEncoder.addBodyAttribute("thridinfo", textArea);
	...
	private List<Entry<String, String>> formget(ClientBootstrap bootstrap,
			String host, int port, String get, URI uriSimple) {
		ChannelFuture future = bootstrap.connect(new InetSocketAddress(host,
				port));
	...
	private List<Entry<String, String>> createPostHeader(
		...
		HttpRequest request = new DefaultHttpRequest(HttpVersion.HTTP_1_1,
				HttpMethod.GET, uriSimple.toASCIIString());
		request.setHeader(HttpHeaders.Names.HOST, host);
		request.setHeader(HttpHeaders.Names.CONNECTION,
				HttpHeaders.Values.CLOSE);
		request.setHeader(HttpHeaders.Names.ACCEPT_ENCODING,
