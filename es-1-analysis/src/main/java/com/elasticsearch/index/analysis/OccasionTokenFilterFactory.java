...
public class OccasionTokenFilterFactory extends AbstractTokenFilterFactory {
	@Inject
	public OccasionTokenFilterFactory(Index index, @IndexSettings Settings indexSettings, @Assisted String name, @Assisted Settings settings) {
		super(index, indexSettings, name, settings);
	}

	@Override
	public TokenStream create(TokenStream tokenStream) {
		return new OccasionTokenFilter(Version.LUCENE_46, tokenStream);
	}
}
