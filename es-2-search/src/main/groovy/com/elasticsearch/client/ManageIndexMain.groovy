...
class ManageIndexMain {
	...
	void createClient() {
		def s = Settings.builder().put(CLUSTER_NAME_FIELD, CLUSTER_NAME).build();
		client = TransportClient.builder().settings(s).build()
		client.addTransportAddress(new InetSocketTransportAddress(
			new InetSocketAddress(ELASTIC_SEARCH_IP, ELASTIC_SEARCH_NATIVE_PORT)))
	}
...
"""
	...
	void createIndexRestStandard(String indexName) {
		if (indexExists(indexName)) {
			println "exist index."
			return
		}
        ...
        "mappings":{
            "article": {
                ...
                "properties": {
                    ...
                    "createDate": {"type": "date", "format":"yyyyMMddHHmmss"},
                    "topic": {"type": "string", "analyzer":"standard"},
                    "sentiment": {"type": "string", "analyzer":"standard"},
                    "occasion": {"type": "string", "analyzer":"standard"}
                    }
                }
            }
          }
...
"""
	...
	void deleteIndex(String indexName) {
		if (indexExists(indexName)) {
			...
			println "$indexName not found index."
		}
	}
	...
	def void analyze() {
		final def content = "RT 배우도 피해갈수 없는 내새끼작아병ㅋㅋㅋ불치병입니다ㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋ"
//		final def content = "RT 배우도 피해갈수 없는 내새끼작아병ㅋㅋㅋ불치병입니다ㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋ"
		def request = new AnalyzeRequest(content)
			.index(INDEX_NAME)
