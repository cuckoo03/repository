...
/**
 * <p>
 * 네이버 블로그 게시물 전체 목록 테스트
 * 첫글 파싱만 됨, 페이지 파싱 테스트 필요 
 * </p>
 * 
 * @author cuckoo03
 *
 */
public class NaverBlogListTest {
//	final String URL = "http://blog.naver.com/PostList.nhn?blogId=pooqksj2&categoryNo=0&from=postList";
