...
public class HtmlUnitTest {
	final String CAFE_URL = "http://cafe.naver.com/malltail.cafe?iframe_url=/ArticleList.nhn%3Fsearch.boardtype=L%26search.menuid=98%26search.questionTab=A%26search.clubid=21820768";
	...
	protected void closeWebClient(WebClient wc) {
		...
		for (int i = 0; i < 0; i++) {
			windows.get(i).getJobManager().removeAllJobs();
		}
	}
