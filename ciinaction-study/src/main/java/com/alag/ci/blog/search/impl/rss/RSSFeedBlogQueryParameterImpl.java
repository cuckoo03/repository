...
public class RSSFeedBlogQueryParameterImpl extends BlogQueryParameterImpl {
	...
	public enum RSSProviderURL {
		FEEDSTER("http://feedster.com/search.php", "offset", "limit", "sort",
				"type", QueryType.SEARCH), BLOGDIGGER(
				"http://www.blogdigger.com/rss.jsp", "si", "pp", "sortby", "",
				QueryType.SEARCH), MSN("http://search.msn.com/results.aspx",
				"first", "count", "", "format", QueryType.SEARCH), BLOGLINE(
				"http://www.bloglines.com/search", "", "", "", "",
				QueryType.SEARCH), TECHNORATI_SEARCH(
				"http://api.technorati.com/search", "", "", "", "",
				QueryType.SEARCH), TECHNORATI_TAG_SEARCH(
				"http://api.technorati.com/tag", "", "", "", "", QueryType.TAG), ICE_ROCKET(
				"http://blogs.icerocket.com/search", "", "", "", "",
				QueryType.SEARCH), PLAZOO(
				"http://www.plazoo.com/en/default.asp", "", "", "", "",
				QueryType.SEARCH);
