...
public class TechnoratiResponseHandler extends BlogSearchResponseHandlerImpl {
	 ...
	 * <weblog> <name>[name of blog containing match]</name> <url>[blog
	 * URL]</url> <rssurl>[blog RSS URL]</rssurl> <atomurl>[blog Atom
	 * URL]</atomurl> <inboundblogs>[inbound blogs]</inboundblogs>
	 * <inboundlinks>[inbound links]</inboundlinks> <lastupdate>[date blog last
	 * updated]</lastupdate> </weblog> <title>[title of entry]</title>
	 * <excerpt>[blurb from entry with search term highlighted]</excerpt>
	 * <created>[date entry was created]</created> <permalink>[URL of blog
	 * entry]</permalink> </item> ... </document> </tapi>
	 * 
	 ...
	 * match the tag]</blogsmatched> <start>[value of the start
	 * parameter]</start> <limit>[value of limit parameter]</limit>
	 * <querytime>[duration of query]</querytime> </result> <item> .... </item>
	 * </document>
	 */

	public enum TechnoratiXmlToken implements XmlToken {
		COUNT("querycount"), POSTSMATCHED("postsmatched"), WEBLOG("weblog"), NAME(
				"name"), LASTUPDATE("lastupdate"), URL("url"), TITLE("title"), EXCERPT(
				"excerpt"), ITEM("item"), CREATED("created"), FIRSTNAME(
