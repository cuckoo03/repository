...
public class TechnoratiTagBlogQueryParameterImpl extends BlogQueryParameterImpl {
	private static final String TECHNORATI_TAG_API_URL = "http://api.technorati.com/tag";
