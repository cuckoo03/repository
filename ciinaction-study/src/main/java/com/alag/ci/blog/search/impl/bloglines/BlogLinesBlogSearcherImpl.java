...
/**
 * http://www.bloglines.com/search?format=publicapi&apiuser=xxx&apikey=xxx&q=
...
public class BlogLinesBlogSearcherImpl extends BlogSearcherImpl {
	...
	protected HttpMethod getMethod(BlogQueryParameter param) {
		String url = param.getMethodUrl()
				...
				+ param.getParameter(QueryParameter.APIUSER) + "&apikey="
				+ param.getParameter(QueryParameter.KEY) + "&q="
