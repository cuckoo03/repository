...
/**
 * Generic class for rss MSN:
 * http://search.msn.com/results.aspx?q=collective+intelligence
 * &format=rss&first=1&count=3 Blogdigger:
 * http://www.blogdigger.com/rss.jsp?sortby=date&q=collective&si=1&pp=2
 * Feedster:
 * http://feedster.com/search.php?q=collective+intelligence&sort=date&type
 * =rss&offset=0&limit=2&language=en
 * 
 * @author Satnam Alag
 *
 */
