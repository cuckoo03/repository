...
public class BlogLinesResponseHandler extends BlogSearchResponseHandlerImpl {
	/**
	 * <publicapi> <link type="rss"
	 * title="Bloglines Search: bloglines+freedback" href=
	 * "http://www.bloglines.com/search?q=bloglines+freedback&s=f&pop=l&news=m&format=rss"
	 * /> <resultset set="main" qtype="article" estimate="115" found="71">
	 * <result id="0" siteid="521144" itemid="455" inline="0"
	 * date="Fri, 20 Oct 2006 20:46:00 GMT" citations="0"> <site nsubs="26">
	 * <name>A Drivel Runs Through It</name>
	 * <url>http://www.patiastephens.com</url>
	 * <feedurl>http://www.patiastephens.com/atom.xml</feedurl> </site>
	 * <title><B>Bloglines</B>, you are breaking my heart</title>
	 * <author>Patia</author> <abstract> Here then, is my <B>freedback</B> for
	 * the <B>Bloglines</B> folks: </abstract> <url>
	 * http://www.patiastephens.com
	 * /2006/10/bloglines-you-are-breaking-my-heart.html </url> </result>
	 * <result id="1" siteid="1732365" itemid="584" inline="0"
	 * date="Tue, 17 Oct 2006 14:16:00 GMT" citations="0"> <site nsubs="16">
	 * <name>The Social Customer Manifesto - recent comments</name>
	 * <url>http://www.socialcustomer.com/</url>
	 * <feedurl>http://www.socialcustomer.com/comments.rdf</feedurl> </site>
	 * <title> Craig comments on ""We&apos;re Listening"" </title> <abstract>
	 * <B>Bloglines</B> support this and actually listen. I&apos;ve had them
	 * visit my site and read my <B>freedback</B>. :) I&apos;d suggest perhaps
	 * rather than companies... </abstract> <url>
	 * http://www.socialcustomer.com/2006/10/were_listening.html </url>
	 * </result> </resultset> </publicapi>
	 *
	 */
	public enum BlogLinesXmlToken implements XmlToken {
		NAME("name"), URL("url"), TITLE("title"), ABSTRACT("abstract"), RESULT(
				"result"), CREATED("date"), AUTHOR("author"), FOUND("found");
	...
	protected boolean isBlogEntryToken(XmlToken t) {
		return (BlogLinesXmlToken.RESULT.compareTo((BlogLinesXmlToken) t) == 0);
	}
