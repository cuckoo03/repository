...
public class WEKATutorial {
	...
	private void predictUnknownCases(Instances learningDataset,
		...
		Instance testMaleInstance = createInstance(learningDataset, 32.,
				"male", 0);
		Instance testFemaleInstance = createInstance(learningDataset, 32.,
				"female", 0);
		double malePrediction = predictiveModel
				.classifyInstance(testMaleInstance);
	...
	private void addInstance(Instances trainingDataSet, double age,
		...
		Instance instance = createInstance(trainingDataSet, age, gender,
				numLogins);
