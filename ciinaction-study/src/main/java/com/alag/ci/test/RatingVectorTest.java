...
public class RatingVectorTest extends TestCase {
	...
	public void testChapter3Example() {
		...
		RatingVector rv1 = new RatingVectorImpl(RatingVector.OwnerType.ITEM,
				item1);
		...
		RatingVector rv2 = new RatingVectorImpl(RatingVector.OwnerType.ITEM,
				item2);
		...
		RatingVector rv3 = new RatingVectorImpl(RatingVector.OwnerType.ITEM,
				item3);
