...
public class MetaDataVectorTest extends TestCase {
	...
	/**
	 * This test tests the dot product functionality It creates two
	 * MetaDataVector and checks to make sure the magnitude of dot product is
	 * correct
	 */
	public void testMetaDataVector() {
		...
		// First test sort order for mdv2 it should be 2, 1 -- based on
		// magnitude
	...
	private void printDotProducts(MetaDataVector item1, MetaDataVector item2,
		...
		System.out.println("John=" + johnitem1 + "," + johnitem2 + ","
				+ johnitem3);
		System.out.println("Jane=" + janeitem1 + "," + janeitem2 + ","
				+ janeitem3);
