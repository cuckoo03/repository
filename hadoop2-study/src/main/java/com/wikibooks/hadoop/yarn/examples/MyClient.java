...
public class MyClient {
	...
	// Amt. of virtual cores to request for container in which the HelloYarn
	// will be executed
	...
	private void initOptions() {
		...
		opts.addOption("appname", true,
				"Application Name. Default value - HelloYarn");
		...
		opts.addOption("container_memory", true,
				"Amount of memory in MB to be requested to run the HelloYarn");
		opts.addOption("container_vcores", true,
				"Amount of virtual cores to be requested to run the HelloYarn");
		opts.addOption("num_containers", true,
				"No. of containers on which the HelloYarn needs to be executed");
	...
	private Map<String, String> getAMEnvironment(
			Map<String, LocalResource> localResources, FileSystem fs)
			throws IOException {
		Map<String, String> env = new HashMap<String, String>();
		// Set ApplicationMaster jar file
		LocalResource appJarResource = localResources
				.get(Constants.AM_JAR_NAME);
		Path hdfsAppJarPath = new Path(fs.getHomeDirectory(), appJarResource
				.getResource().getFile());
		...
		for (String c : conf.getStrings(
			...
			classPathEnv.append(File.separatorChar);
